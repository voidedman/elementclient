...
namespace Element.ClientBase.EntityBase
{
    internal class Actor
    {
        ...
        public Element Teleport(AABB advancedAxis)
        {
        ...
        public Element Teleport(float x, float y, float z)
        {
            Teleport(new AABB(Base.Vec3(x, y, z), Base.Vec3(x + .6f, y + 1.8f, z + .6f)));
        } // Teleportation

        public Element Teleport(Vector3 _Vec3)
        {
