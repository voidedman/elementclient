...
using System.Linq;
using Element.ClientBase.EntityBase;
...
namespace Element.ClientBase
{
    internal class Game
    {
        ...
        public static Element teleport(AABB advancedAxis)
        {
        ...
        public static Element vclip(float y)
        {
        ...
        public static Element vflip(float y)
        {
            MCM.writeFloat(localPlayer + VersionClass.GetData("velocity") + 4, y);
        } // Teleportation

        public static Element swing()
        {
            swingAn = 1;
        } // Fake a swing packet

        public static Element teleport(float x, float y, float z)
        {
            teleport(new AABB(Base.Vec3(x, y, z), Base.Vec3(x + .6f, y + 1.8f, z + .6f)));
        } // Teleportation

        public static Element teleport(Vector3 _Vec3)
        {
            teleport(_Vec3.x, _Vec3.y, _Vec3.z);
        } // Teleportation

        public static Element SexActor(Actor actor, float width = 0.3f, float height = 1f)
        {
        ...
        public static Element setFieldOfView(float v)
        {
            MCM.writeFloat(localPlayer + VersionClass.GetData("fieldOfView"), v);
        }

        public static Element resetFieldOfView()
        {
            setFieldOfView(1f);
        }

        public static Element Attack(Actor actor)
        {
        ...
        public static class CustomDefines
        {
            ...
            public static List<string> friends = new List<string> { "FootlongElement" };
        }
