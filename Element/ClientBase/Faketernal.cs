...
using Element.ClientBase.FaketernalBase;
...
namespace Element.ClientBase
{
    internal class Faketernal
    {
        ...
        public static class Potions
        {
            ...
            public static Element CreateAction(Action<int, int> actionTick, iRGB effectColor, int time = 30, int strength = 1, float fov = 1, Action actionExit = null)
            {
