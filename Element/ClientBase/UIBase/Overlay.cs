...
using Element.ClientBase.UIBase.ElementUILibrary;
using Element.ClientBase.VersionBase;
using Element.Modules;
using Element.Modules.vModuleExtra;

#endregion

namespace Element.ClientBase.UIBase
{
    public partial class Overlay : Form
    {
        ...
        [DllImport("user32.dll")]
        public static extern uint GetWindowThreadProcessId(IntPtr hWnd, IntPtr ElementProcessId);

        public delegate Element WinEventDelegate(IntPtr hWinEventHook, uint eventType, IntPtr hwnd, int idObject, int idChild, uint dwEventThread, uint dwmsEventTime);
        ...
        private Element adjust(IntPtr hWinEventHook, uint eventType, IntPtr hwnd, int idObject, int idChild, uint dwEventThread, uint dwmsEventTime)
        {
        ...
        private Element timer1_Tick(object sender, EventArgs e)
        {
            /*var list = "";
        ...
        private Element updateModule(Module mod, Panel c) // fixed a second time ;p
        {
        ...
        private Element Overlay_Paint(object sender, PaintEventArgs e)
        {
            //e.Graphics.DrawString("Element Template", df, Brushes.Orange, new PointF(0, 0));
        }

        private Element panel2_MouseDown_1(object sender, MouseEventArgs e)
        {
        ...
        private Element panel2_MouseMove_1(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
        ...
        private Element Overlay_Load(object sender, EventArgs e)
        {
        ...
        private Element actorPress(object sender, MouseEventArgs e) // did this while upset please ignore
        {
        ...
        private Element actorBind(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        Element InvalidateCategories() // update category sizes depending on moduleList size
        {
            SuspendLayout();
        ...
        Element cValidate(Panel miniPanel, Panel titlePanel)
        {
        ...
        private Element keybindActivated(object sender, MouseEventArgs e) // remove atani like keybind system
        {
        ...
        private Element catchKeybind(object sender, KeyEventArgs e)
        {
        ...
        private Element vCatchKeybind(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Escape || e.KeyCode == Keys.Delete)
            {
        ...
        private Element panel3_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel3_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element ClonableButton_Click(object sender, EventArgs e)
        {
        }

        private Element panel1_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel1_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element panel6_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel6_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element panel14_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel14_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element panel8_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel8_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element panel10_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel10_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element panel12_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel12_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element panel16_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel16_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element timer2_Tick(object sender, EventArgs e)
        {
        ...
        private Element timer3_Tick(object sender, EventArgs e)
        {
            if (!Game.isNull)
        ...
        private Element label12_Click_1(object sender, EventArgs e)
        {

        }

        private Element Overlay_ResizeBegin(object sender, EventArgs e) => SuspendLayout();
        private Element Overlay_ResizeEnd(object sender, EventArgs e) => ResumeLayout();

        private Element button2_Click(object sender, EventArgs e)
        {
            panel18.Visible = false;
        }

        private Element button1_Click(object sender, EventArgs e)
        {
            Game.teleport((int)numericUpDown1.Value, (int)numericUpDown2.Value, (int)numericUpDown3.Value);
        }

        private Element panel18_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel18_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element label4_MouseDown(object sender, MouseEventArgs e) => panel8_MouseDown(sender, e); // worked
        private Element label4_MouseMove(object sender, MouseEventArgs e) => panel8_MouseMove(sender, e);

        private Element label10_MouseDown(object sender, MouseEventArgs e) => panel16_MouseDown(sender, e);
        private Element label10_MouseMove(object sender, MouseEventArgs e) => panel16_MouseMove(sender, e);

        private Element label8_MouseDown(object sender, MouseEventArgs e) => panel12_MouseDown(sender, e);
        private Element label8_MouseMove(object sender, MouseEventArgs e) => panel12_MouseMove(sender, e);

        private Element label6_MouseDown(object sender, MouseEventArgs e) => panel2_MouseDown_1(sender, e);
        private Element label6_MouseMove(object sender, MouseEventArgs e) => panel2_MouseMove_1(sender, e);

        private Element label5_MouseDown(object sender, MouseEventArgs e) => panel6_MouseDown(sender, e);
        private Element label5_MouseMove(object sender, MouseEventArgs e) => panel6_MouseMove(sender, e);

        private Element label9_MouseDown(object sender, MouseEventArgs e) => panel14_MouseDown(sender, e);
        private Element label9_MouseMove(object sender, MouseEventArgs e) => panel14_MouseMove(sender, e);

        private Element label7_MouseDown(object sender, MouseEventArgs e) => panel10_MouseDown(sender, e);
        private Element label7_MouseMove(object sender, MouseEventArgs e) => panel10_MouseMove(sender, e);

        private Element button3_Click(object sender, EventArgs e)
        {
        ...
        private Element button4_Click(object sender, EventArgs e)
        {
            Faketernal.Potions.ClearActions();
        }

        private Element button5_Click(object sender, EventArgs e)
        {
        ...
        private Element panel21_MouseDown(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
        ...
        private Element panel21_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button != MouseButtons.Left) return;
        ...
        private Element label11_MouseDown(object sender, MouseEventArgs e) => panel21_MouseDown(sender, e);
        private Element label11_MouseMove(object sender, MouseEventArgs e) => panel21_MouseMove(sender, e);

        private Element button6_Click(object sender, EventArgs e)
        {
        ...
        private Element button7_Click(object sender, EventArgs e)
        {
        ...
        private Element button8_Click(object sender, EventArgs e)
        {
        ...
        private Element button9_Click(object sender, EventArgs e)
        {
        ...
        private Element button10_Click(object sender, EventArgs e)
        {
            Faketernal.Potions.CreateAction((i, c) => { // give custom effect
        ...
        private Element button11_Click(object sender, EventArgs e)
        {
        ...
        private Element button12_Click(object sender, EventArgs e)
        {
            Faketernal.Potions.CreateAction((i, c) => { // give custom effect
        ...
        private Element panel21_MouseClick(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
        ...
        private Element label11_MouseClick(object sender, MouseEventArgs e) => panel21_MouseClick(sender, e);

        private Element label15_Click(object sender, EventArgs e)
        {

        }

        private Element label14_Click(object sender, EventArgs e)
        {

        }

        private Element panel23_Paint(object sender, PaintEventArgs e)
        {
